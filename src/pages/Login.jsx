        ...
        <div className='login-main bg-white h-screen w-full flex flex-col justify-center items-center font-open bg-no-repeat bg-center bg-cover' style={{ backgroundImage: `url(${loginBG})` }}>
            <div className='login-wrap bg-[#f3f7ff] w-full max-w-[900px] m-auto: rounded-2xl'>
                <div className='content-wrap w-full max-w-[650px] p-2 py-28 m-auto'>
                    <h1 className='text-center text-3xl font-bold font-open text-theme capitalize mb-2'>  <Link to="/">get started</Link> </h1>
                    ...
                    <form className='pt-12 pb-4' onSubmit={handleSubmit(data => console.log(data))}>
                        <input type="text" {...register('email')} placeholder='Email' className='w-full placeholder:text-base placeholder:text-theme-gray bg-white rounded-xl h-[50px] py-2 px-4 mb-6 focus:outline-2 focus:outline-theme'/>
                        <input type="password" {...register('pwd')} placeholder='Password' className='w-full placeholder:text-base placeholder:text-theme-gray bg-white rounded-xl h-[50px] py-2 px-4 focus:outline-2 focus:outline-theme'/>
